...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'content/sprites/bird.png'
BACKGROUND = 'content/sprites/background.png'
PIPE = 'content/sprites/pipe.png'
...
def mainGame():
    ...
    while True:
        ...
        # This function returns true when player is crashed
...
if __name__ == '__main__':
    # This is main point of the game from where it starts
    pygame.init()  # Initialize all pygame modules
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_caption('Flappy Bird by SarfarazKhan')
    ...
    GAME_SPRITES['message'] = pygame.image.load(
        'content/sprites/message.png').convert_alpha()
    GAME_SPRITES['base'] = pygame.image.load(
        'content/sprites/base.png').convert_alpha()
    GAME_SPRITES['pipe'] = (
    ...
    # Game sounds
    GAME_SOUNDS['die'] = pygame.mixer.Sound('content/audio/die.wav')
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('content/audio/hit.wav')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('content/audio/point.wav')
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('content/audio/swoosh.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('content/audio/wing.wav')

    GAME_SPRITES['background'] = pygame.image.load(BACKGROUND).convert()
    GAME_SPRITES['player'] = pygame.image.load(PLAYER).convert_alpha()

    while True:
        welcomeScreen()  # show welcome screen to the user until a button is pressed
